          ...
          <ul class="social-icons3">
            <li>
              <a href="https://www.instagram.com/">
                <img src={instagram} className="instaimg" alt="instaIcon" />{" "}
              </a>
            </li>
            <li>
              <a href="https://twitter.com/">
                <img src={twitter} className="instaimg" alt="twitterIcon" />{" "}
              </a>
            </li>
            <li>
              <a href="https://mail.google.com/">
                <img src={gmail} className="instaimg" alt="emailIcon" />
              </a>
            </li>
          </ul>
        </div>
        <div class="contact-bnr-w3-agile">
          <ul>
            <li>
              ...
              <a href="mailto:info@example.com">INFO@SUNSHINE.COM</a>
            </li>
            <li>
            ...
            >
              <nav class="menu menu--iris">
                <ul class="nav navbar-nav menu__list">
                  ...
                  <li class="menu__item">
                    <a href="#about" class="menu__link scroll">
                      About
                    </a>
                  </li>
                  <li class="menu__item">
                    <a href="#gallery" class="menu__link scroll">
                      Gallery
                    </a>
                  </li>
                  <li class="menu__item">
                    <a href="#rooms" class="menu__link scroll">
                      Rooms
                    </a>
                  </li>
                  <li class="menu__item">
                    <a href="#contact" class="menu__link scroll">
                      Contact Us
                    </a>
                  </li>
                  <li class="menu__item">
                    <a href="/userSignup" class="menu__link scroll">
                      Sign up{" "}
                    </a>
                  </li>
                  {isLoggedIn && (
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <p>
                  ...
                  with its exceptional amenities, makes Star Hotel one of bests
                  in its kind.Try our food menu, awesome services and friendly
              ...
              <div class="advantage-bottom">
                ...
                >
                  <div class="advantage-block">
                    ...
                    <p>
                      want luxurious vacation? Get accommodation today. Book
                      your Romms now.
                    </p>
                    <p>
                      <i class="fa fa-check" aria-hidden="true"></i>Decorated
                      room, proper air conditioned
                    </p>
                    <p>
                      <i class="fa fa-check" aria-hidden="true"></i>Private
                      balcony
                    </p>
                  </div>
                </div>
                ...
                >
                  <div class="advantage-block">
                    ...
                    <p>
                      Try our food menu, awesome services and friendly staff
                      while you are here.
                    </p>
                    <p>
                      <i class="fa fa-check" aria-hidden="true"></i>24 hours
                      room service
                    </p>
                    <p>
                ...
                <div class="price-block agile room-card border">
                  <div class="price-gd-top">
                    <img
                      src={g2}
                      alt=" "
                      class="img-responsive r-img room-card"
                    />
                    <h4>Luxury Room</h4>
                  </div>
                  <div class="price-gd-bottom">
          ...
          <div class="container">
            ...
            >
              ...
              <p class="contact-agile1">
                <strong>Phone :</strong>+91 9359613329
              </p>
              <p class="contact-agile1">
                <strong>Email :</strong>{" "}
                <a href="mailto:name@example.com">INFO@SUNSHINE.COM</a>
              </p>
              <p class="contact-agile1">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d242117.70949245925!2d73.6978103772867!3d18.524870312218948!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf2e67461101%3A0x828d43bf9d9ee343!2sPune%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1728055465128!5m2!1sen!2sin"
                width="600"
                height="450"
                style={{ border: 0 }}
                allowfullscreen=""
